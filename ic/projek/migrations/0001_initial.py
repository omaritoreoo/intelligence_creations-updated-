    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='project_documents/', verbose_name='File Dokumen')),
                ('document_type', models.CharField(choices=[('technical', 'Dokumen Teknis'), ('report', 'Laporan'), ('other', 'Lain-lain')], default='other', max_length=50, verbose_name='Tipe Dokumen')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploaded_documents', to=settings.AUTH_USER_MODEL, verbose_name='Diunggah Oleh')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='projek.project', verbose_name='Proyek Terkait')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('external_reply_id', models.CharField(blank=True, max_length=255, null=True, unique=True, verbose_name='ID Balasan Eksternal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_performance', models.JSONField(help_text="(contoh: {'akurasi': 0.89, 'f1_score': 0.85})", verbose_name='Performa Model')),
                ('model_path', models.FileField(blank=True, help_text='Unggah file model yang sudah terlatih (misal: .pkl, .h5, .pt).', null=True, upload_to='trained_models/', verbose_name='Lokasi File Model')),
